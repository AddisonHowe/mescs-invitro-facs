...
figname=fig4a_pca_facs_v4_2b_1
sleeptime=3
...
aioutdir=${PROJ_DIR}/out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/ai
mkdir -p $aioutdir
...
rundirs=(
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/2.0
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/2.5
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/3.0
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/3.5
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/4.0
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/4.5
    out/4a_dimred_pca/facs_v4/dec2_fitonsubset/images/pc1pc2/5.0
)
