...
template_linkdir=$PROJ_DIR_TILDE/scripting/images_fig3  # NOTE: hardcoded

# This is where all generated ai files will be stored, one for every run below.
aioutdir=${PROJ_DIR}/out/2a_isolate1/ai
mkdir -p $aioutdir
...
rundirs=(
    out/2a_isolate1/images/gexp3d/2.0
    out/2a_isolate1/images/gexp3d/2.5
    out/2a_isolate1/images/gexp3d/3.0
    out/2a_isolate1/images/gexp3d/3.5
    out/2a_isolate1/images/gexp3d/4.0
    out/2a_isolate1/images/gexp3d/4.5
    out/2a_isolate1/images/gexp3d/5.0
)
