...
template_linkdir=$PROJ_DIR_TILDE/scripting/images_${figname}

# This is where all generated ai files will be stored, one for every run below.
aioutdir=${PROJ_DIR}/out/2a_postcluster_plots/ai
mkdir -p $aioutdir
...
rundirs=(
    out/2a_postcluster_plots/images/2.0
    out/2a_postcluster_plots/images/2.5
    out/2a_postcluster_plots/images/3.0
    out/2a_postcluster_plots/images/3.5
    out/2a_postcluster_plots/images/4.0
    out/2a_postcluster_plots/images/4.5
    out/2a_postcluster_plots/images/5.0
)
